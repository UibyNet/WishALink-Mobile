...
export class ChatApiService {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<RoomMessagesModel>><any>_observableThrow(e);
                }
            } else
                return <Observable<RoomMessagesModel>><any>_observableThrow(response_);
        }));
    }
    ...
    protected processGetmessages(response: HttpResponseBase): Observable<RoomMessagesModel> {
        ...
        return _observableOf<RoomMessagesModel>(<any>null);
    }
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<RoomListModel[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<RoomListModel[]>><any>_observableThrow(response_);
        }));
    }
    ...
    protected processGetrooms(response: HttpResponseBase): Observable<RoomListModel[]> {
        ...
        return _observableOf<RoomListModel[]>(<any>null);
    }
    ...
    getroom(id: number | undefined, connectionId: string | undefined): Observable<RoomListModel> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetroom(<any>response_);
                } catch (e) {
                    return <Observable<RoomListModel>><any>_observableThrow(e);
                }
            } else
    ...
    getorcreateroom(participantId: number | undefined, connectionId: string | undefined): Observable<RoomListModel> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetorcreateroom(<any>response_);
                } catch (e) {
                    return <Observable<RoomListModel>><any>_observableThrow(e);
                }
            } else
    ...
    editroom(id: number | undefined, body: RoomEditModel | undefined): Observable<RoomListModel> {
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processEditroom(<any>response_);
                } catch (e) {
                    return <Observable<RoomListModel>><any>_observableThrow(e);
                }
            } else
    ...
    leaveroom(id: number | undefined, connectionId: string | undefined): Observable<void> {
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processLeaveroom(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
...
export class PostApiService {
    ...
    suggestions(): Observable<PostListModel[]> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSuggestions(<any>response_);
                } catch (e) {
                    return <Observable<PostListModel[]>><any>_observableThrow(e);
                }
            } else
...
export class RoomListModel implements IRoomListModel {
    ...
    readonly participants?: SocialUserListModel[] | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["Participants"])) {
                (<any>this).participants = [] as any;
                for (let item of _data["Participants"])
                    (<any>this).participants!.push(SocialUserListModel.fromJS(item));
            }
        }
    }
