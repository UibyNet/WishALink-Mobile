...
export class ApiService {
    ...
    /**
     * Executes a credit card payment transaction with card and customer info
     * @param body Information about the payment
     * @return The credit card payment is made successfully
     */
    makeDirectCCPayment(body: CCPaymentRequestDTO): Observable<PaymentSummaryDTO> {
        let url_ = this.baseUrl + "/CCPayment";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processMakeDirectCCPayment(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processMakeDirectCCPayment(<any>response_);
                } catch (e) {
    ...
    protected processMakeDirectCCPayment(response: HttpResponseBase): Observable<PaymentSummaryDTO> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    /**
     * Executes a credit card payment transaction for a member with a stored card
     ...
     * @return The credit card payment is made successfully
     */
    makeCCPayment(memberID: string, cardID: string, body: MemberCCPaymentRequestDTO): Observable<PaymentSummaryDTO> {
        let url_ = this.baseUrl + "/CCPayment/{MemberID}/Card/{CardID}";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processMakeCCPayment(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processMakeCCPayment(<any>response_);
                } catch (e) {
                    return <Observable<PaymentSummaryDTO>><any>_observableThrow(e);
                }
            } else
    ...
    protected processMakeCCPayment(response: HttpResponseBase): Observable<PaymentSummaryDTO> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    /**
     * Executes a point payment transaction with a started transcation
     * @param body Information about the payment
     * @return The point payment is made successfully
     */
    makePointPayment(body: PointPaymentRequestDTO): Observable<PaymentSummaryDTO> {
        let url_ = this.baseUrl + "/PointPayment";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processMakePointPayment(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processMakePointPayment(<any>response_);
                } catch (e) {
                    return <Observable<PaymentSummaryDTO>><any>_observableThrow(e);
                }
            } else
    ...
    protected processMakePointPayment(response: HttpResponseBase): Observable<PaymentSummaryDTO> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    /**
     * Returns information about a given payment by it's KPayTxnID
     * @param kPayTxnID KPay transaction ID (GUID) (e.g. 88091384-7d85-47a1-97eb-6573d706eedc)
     * @return OK (The request has succeeded)
     */
    getPayment(kPayTxnID: string): Observable<PaymentSummaryDTO> {
        let url_ = this.baseUrl + "/Payment/{KPayTxnID}";
    ...
    protected processGetPayment(response: HttpResponseBase): Observable<PaymentSummaryDTO> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    /**
     * Returns the status of a given payment by it's KPayTxnID
     * @param kPayTxnID KPay transaction ID (GUID) (e.g. 88091384-7d85-47a1-97eb-6573d706eedc)
     * @return OK (The request has succeeded)
     */
    getPaymentStatus(kPayTxnID: string): Observable<PaymentStatusEnum | null> {
        let url_ = this.baseUrl + "/Payment/{KPayTxnID}/Status";
        if (kPayTxnID === undefined || kPayTxnID === null)
            throw new Error("The parameter 'kPayTxnID' must be defined.");
        url_ = url_.replace("{KPayTxnID}", encodeURIComponent("" + kPayTxnID));
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return OK (The request has succeeded)
     */
    refundPayment(kPayTxnID: string): Observable<APIResultDTO> {
        let url_ = this.baseUrl + "/Payment/{KPayTxnID}/Refund";
        if (kPayTxnID === undefined || kPayTxnID === null)
            throw new Error("The parameter 'kPayTxnID' must be defined.");
        url_ = url_.replace("{KPayTxnID}", encodeURIComponent("" + kPayTxnID));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processRefundPayment(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processRefundPayment(<any>response_);
                } catch (e) {
                    return <Observable<APIResultDTO>><any>_observableThrow(e);
                }
            } else
    ...
    protected processRefundPayment(response: HttpResponseBase): Observable<APIResultDTO> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class MemberCCPaymentRequestDTO implements IMemberCCPaymentRequestDTO {
    checkoutCode!: string;
    ...
    /** Number of installments for the payment (Currently only 1 is supported) */
    creditCardInstallments!: number;
    useThreeDS?: boolean | undefined;
    /** Credit card CVC */
    creditCardCVC?: string;
    sellerMemberID?: string;
    paymentRequestKPayTxnID?: string;
    ...
    /** Amount of points used, if any (Use at most 2 decimal digits) */
    ...
    paymentRequestLines?: CCPaymentRequestLineDTO[];

    constructor(data?: IMemberCCPaymentRequestDTO) {
        if (data) {
    ...
    static fromJS(data: any): MemberCCPaymentRequestDTO {
        data = typeof data === 'object' ? data : {};
        let result = new MemberCCPaymentRequestDTO();
        result.init(data);
        return result;
    }
...
/** Information about the payment request */
export interface IMemberCCPaymentRequestDTO {
    checkoutCode: string;
    /** The requested payment amount (Use at most 2 decimal digits) */
    transactionAmountTRY: number;
    /** The unique transaction ID the merchant system has assigned to this payment */
...
/** Information about the payment request */
export class CCPaymentRequestDTO implements ICCPaymentRequestDTO {
    memberID!: string;
    checkoutCode!: string;
    /** The requested payment amount (Use at most 2 decimal digits) */
    transactionAmountTRY!: number;
    ...
    constructor(data?: ICCPaymentRequestDTO) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CCPaymentRequestDTO {
        data = typeof data === 'object' ? data : {};
        let result = new CCPaymentRequestDTO();
        result.init(data);
        return result;
    }
...
/** Information about the payment request */
export interface ICCPaymentRequestDTO {
    memberID: string;
    checkoutCode: string;
    /** The requested payment amount (Use at most 2 decimal digits) */
    transactionAmountTRY: number;
...
/** Information about the payment request */
export class PointPaymentRequestDTO implements IPointPaymentRequestDTO {
    memberID!: string;
    checkoutCode!: string;
    paymentRequestKPayTxnID!: string;
    /** The unique transaction ID the merchant system has assigned to this payment */
    ...
    constructor(data?: IPointPaymentRequestDTO) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PointPaymentRequestDTO {
        data = typeof data === 'object' ? data : {};
        let result = new PointPaymentRequestDTO();
        result.init(data);
        return result;
    }
...
/** Information about the payment request */
export interface IPointPaymentRequestDTO {
    memberID: string;
    checkoutCode: string;
    paymentRequestKPayTxnID: string;
    /** The unique transaction ID the merchant system has assigned to this payment */
